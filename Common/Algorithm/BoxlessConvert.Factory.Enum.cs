...
namespace MaTech.Common.Algorithm {
    public static partial class BoxlessConvert {
        private static class EnumCasterFactory<TEnum> where TEnum : unmanaged, Enum, IConvertible {
            ...
            private static TResult ReinterpretCast<TSource, TResult>(TSource value) where TSource : unmanaged where TResult : unmanaged {
                unsafe {
            ...
            private static (Func<Delegate?>, Func<Delegate?>) CreateCasterFactory<TUnderlying, T>() where TUnderlying : unmanaged {
            ...
            private static void InitializeDictForUnderlyingType<TUnderlying>() where TUnderlying : unmanaged {
                dict = new Dictionary<Type, (Func<Delegate?>, Func<Delegate?>)>{
                    { typeSByte, CreateCasterFactory<TUnderlying, SByte>() },
                    { typeByte, CreateCasterFactory<TUnderlying, Byte>() },
                    { typeInt16, CreateCasterFactory<TUnderlying, Int16>() },
                    { typeUInt16, CreateCasterFactory<TUnderlying, UInt16>() },
                    { typeInt32, CreateCasterFactory<TUnderlying, Int32>() },
                    { typeUInt32, CreateCasterFactory<TUnderlying, UInt32>() },
                    { typeInt64, CreateCasterFactory<TUnderlying, Int64>() },
                    { typeUInt64, CreateCasterFactory<TUnderlying, UInt64>() },
                };
            }
            ...
            static EnumCasterFactory() {
                ...
                throw new NotSupportedException($"[BoxlessConvert] The underlying type of enum is {underlyingType}, which is unsupported. Is this something new in language specifications?");
            }
