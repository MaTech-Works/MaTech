    ...
    public partial class ChartPlayer {
        ...
        public class TimeCarrier : Carrier {
            ...
            public void CopyEffectFrom(TimeCarrier other) {
                speed = other.speed;
                effectScrollSpeed = other.effectScrollSpeed;
                effectNoteSpeed = other.effectNoteSpeed;
                effectJumpTime = 0; // 始终清空
